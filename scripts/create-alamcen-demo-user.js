...
const DEMO_EMAIL = "almacen.demo@saaspro.com";
const DEMO_FULL_NAME = "Almacen Demo";
const DEMO_TENANT_NAME = "Almacen Demo";
const DEMO_TENANT_SLUG = "almacen-demo";
...
async function main() {
  ...
  const demoPassword = getRequiredEnv("ALAMCEN_DEMO_PASSWORD");
